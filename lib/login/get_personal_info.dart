...
class GetPersonalInfoPage extends StatefulWidget {
  @override
  _GetPersonalInfoPageState createState() => _GetPersonalInfoPageState();
}

class _GetPersonalInfoPageState extends State<GetPersonalInfoPage> {
