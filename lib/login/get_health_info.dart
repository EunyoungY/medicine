...
class GetHealthInfoPage extends StatefulWidget {
  @override
  _GetHealthInfoPageState createState() => _GetHealthInfoPageState();
}

class _GetHealthInfoPageState extends State<GetHealthInfoPage> {
